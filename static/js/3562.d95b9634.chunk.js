...
return fallOffFunction(vv, vn, 0.1);
      ...
      fragOcclusion = A;`),e}function p(e){return Math.max(10,20*e.computeScreenPixelSizeAtDist(Math.abs(4*e.relativeElevation)))}const g=(0,a.vt)(),f=Object.freeze(Object.defineProperty({__proto__:null,build:v,getRadius:p},Symbol.toStringTag,{value:"Module"}))},20738:(e,t,o)=>{o.d(t,{S:()=>m,b:()=>h});var i=o(16428),a=o(71752),r=o(27879),n=o(37580),s=o(14209),l=o(33509),c=o(86820),d=o(23133);const u=4;function h(){const e=new l.N5,t=e.fragment;e.include(i.c);const o=(u+1)/2,h=1/(2*o*o);return t.include(a.E),t.uniforms.add(new d.N("depthMap",(e=>e.depthTexture)),new c.o("tex",(e=>e.colorTexture)),new r.t("blurSize",(e=>e.blurSize)),new n.m("projScale",((e,t)=>{const o=t.camera.distance;return o>5e4?Math.max(0,e.projScale-(o-5e4)):e.projScale}))),t.code.add(s.H`
  ...
  `)}},68788:(e,t,o)=>{o.d(t,{M:()=>a});var i=o(14209);function a(e){e.vertex.code.add(i.H`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
return posClip;
    ...
    }`)}const b=(0,s.vt)()},35930:(e,t,o)=>{o.d(t,{K:()=>l});var i=o(19195),a=o(42248),r=o(14209),n=o(64216),s=o(25812);function l(e,t){t.hasSymbolColors?(e.include(i.A),e.attributes.add(n.r.SYMBOLCOLOR,"vec4"),e.varyings.add("colorMixMode","mediump float"),e.vertex.code.add(r.H`int symbolColorMixMode;
vec4 getSymbolColor() {
...
void forwardColorMixMode() {}`))}},57712:(e,t,o)=>{o.d(t,{E:()=>b});var i=o(42434),a=o(65339),r=o(85131),n=o(38217),s=o(56172),l=o(54282),c=o(34358),d=o(21428),u=o(53157),h=o(68626),m=o(73073),v=o(60400),p=o(29191),g=o(14209),f=o(23133),x=o(83636);function b(e,t){const{vertex:o,fragment:b}=e,T=t.hasColorTexture&&t.alphaDiscardMode!==x.sf.Opaque,{output:M,normalType:w,hasColorTextureTransform:y}=t;switch(M){case a.V.Depth:(0,p.NB)(o,t),e.include(n.d,t),e.include(r.HQ,t),e.include(c.U,t),T&&b.uniforms.add(new f.N("tex",(e=>e.texture))),o.main.add(g.H`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
...
forwardTextureCoordinates();`),e.include(r.HQ,t),e.include(v.S,t),e.include(h.Q,t),b.main.add(g.H`
          ...
          ${(0,g.If)(T,g.H`vec4 texColor = texture(tex, ${y?"colorUV":"vuv0"});
                 discardOrAdjustAlpha(texColor);`)}
          calculateOcclusionAndOutputHighlight();`)}}},53157:(e,t,o)=>{o.d(t,{L:()=>n});var i=o(65339),a=o(96174),r=o(14209);function n(e,t){switch(t.output){case i.V.Shadow:case i.V.ShadowHighlight:case i.V.ShadowExcludeHighlight:case i.V.ViewshedShadow:e.fragment.include(a.U),e.fragment.code.add(r.H`float _calculateFragDepth(const in float depth) {
...
}`)}}},20995:(e,t,o)=>{o.d(t,{W:()=>p});var i=o(71958),a=o(16687),r=o(34358),n=o(81691),s=o(66870),l=o(57226),c=o(14209),d=o(97816),u=o(86820),h=o(23133),m=o(51203),v=o(64216);function p(e,t){const o=e.fragment;t.hasVertexTangents?(e.attributes.add(v.r.TANGENT,"vec4"),e.varyings.add("vTangent","vec4"),t.doubleSidedMode===s.W.WindingOrder?o.code.add(c.H`mat3 computeTangentSpace(vec3 normal) {
...
}`))}},58001:(e,t,o)=>{o.d(t,{W:()=>u});var i=o(68358),a=o(90646),r=o(32345),n=o(6857),s=o(35934),l=o(31707),c=o(74368),d=o(14209);function u(e,t){const o=e.fragment,a=void 0!==t.lightingSphericalHarmonicsOrder?t.lightingSphericalHarmonicsOrder:2;0===a?(o.uniforms.add(new l.t("lightingAmbientSH0",((e,t)=>(0,i.i)(h,t.lighting.sh.r[0],t.lighting.sh.g[0],t.lighting.sh.b[0])))),o.code.add(d.H`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
...
return outColor;
}`);break;default:(0,i.Xb)(t.pbrMode);case l.A9.COUNT:}}},66870:(e,t,o)=>{o.d(t,{W:()=>i,r:()=>n});var i,a=o(64414),r=o(14209);function n(e,t){const o=e.fragment;switch(o.code.add(r.H`struct ShadingNormalParameters {
vec3 normalView;
vec3 viewDirection;
...
}`);break;default:(0,a.Xb)(t.doubleSidedMode);case i.COUNT:}}!function(e){e[e.None=0]="None",e[e.View=1]="View",e[e.WindingOrder=2]="WindingOrder",e[e.COUNT=3]="COUNT"}(i||(i={}))},95069:(e,t,o)=>{o.d(t,{Bz:()=>m,G:()=>h});o(30185),o(90646);var i=o(96174),a=o(74368),r=o(42248),n=o(14209),s=o(29337),l=o(51203);class c extends s.n{constructor(e,t,o){super(e,"mat4",l.c.Draw,((o,i,a,r)=>o.setUniformMatrix4fv(e,t(i,a,r))),o)}}class d extends s.n{constructor(e,t,o){super(e,"mat4",l.c.Pass,((o,i,a)=>o.setUniformMatrix4fv(e,t(i,a))),o)}}var u=o(23133);n.Y;n.Y;function h(e,t){t.receiveShadows&&(e.fragment.uniforms.add(new d("shadowMapMatrix",((e,t)=>t.shadowMap.getShadowMapMatrices(e.origin)),4)),v(e))}function m(e,t){t.receiveShadows&&(e.fragment.uniforms.add(new c("shadowMapMatrix",((e,t)=>t.shadowMap.getShadowMapMatrices(e.origin)),4)),v(e))}function v(e){const t=e.fragment;t.include(i.U),t.uniforms.add(new u.N("shadowMap",((e,t)=>t.shadowMap.depthTexture)),new r.c("numCascades",((e,t)=>t.shadowMap.numCascades)),new a.E("cascadeDistances",((e,t)=>t.shadowMap.cascadeDistances))).code.add(n.H`int chooseCascade(float depth, out mat4 mat) {
...
}`)}},47266:(e,t,o)=>{o.d(t,{MU:()=>c,O1:()=>d,QM:()=>u,Sx:()=>l,q2:()=>s});var i=o(71958),a=o(34358),r=o(14209),n=o(97816);function s(e,t){t.hasColorTextureTransform?(e.varyings.add("colorUV","vec2"),e.vertex.uniforms.add(new n.k("colorTextureTransformMatrix",(e=>e.colorTextureTransformMatrix??i.zK))).code.add(r.H`void forwardColorUV(){
...
color.a = 1.0;
}`);break;case s.sf.Mask:a.uniforms.add(o).code.add(n.H`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } else { color.a = 1.0; } }`);break;case s.sf.MaskBlend:a.uniforms.add(o).code.add(n.H`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } }`)}}},50914:(e,t,o)=>{o.d(t,{N:()=>n});var i=o(69868),a=o(92673),r=o(14209);function n(e){e.include(a.a),e.code.add(r.H`
  ...
  `)}},96174:(e,t,o)=>{o.d(t,{U:()=>a});var i=o(14209);function a(e){e.code.add(i.H`const float MAX_RGBA4_FLOAT =
15.0 / 16.0 +
15.0 / 16.0 / 16.0 +
15.0 / 16.0 / 16.0 / 16.0 +
