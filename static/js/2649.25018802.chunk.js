...
}`))}},53353:(e,t,i)=>{i.d(t,{q:()=>m,h:()=>v});var r=i(18735),n=i(29191),o=i(74368),s=i(37580),a=i(14209),l=i(23133);i(19208),i(5719),i(67542),i(17743);function c(e){return e.pattern.map((t=>Math.round(t*e.pixelRatio)))}function d(e){if(null==e)return 1;const t=c(e);return Math.floor(t.reduce(((e,t)=>e+t)))}function p(e){return c(e).reduce(((e,t)=>Math.max(e,t)))}var h=i(32345),u=i(6857);const f=(0,u.vt)();function m(e,t){t.stippleEnabled?function(e,t){const i=!(t.draped&&t.stipplePreferContinuous),{vertex:c,fragment:d}=e;d.include(r.W),t.draped||((0,n.yu)(c,t),c.uniforms.add(new s.m("worldToScreenPerDistanceRatio",((e,t)=>1/t.camera.perScreenPixelRatio))),c.code.add(a.H`float computeWorldToScreenRatio(vec3 segmentCenter) {
...
#define blendStipple(color, _stippleAlpha_) color`)}(e)}function v(e){const t=e.stipplePattern;return t?d(e.stipplePattern)/t.pixelRatio:1}const g=a.H.float(.4)},34328:(e,t,i)=>{i.d(t,{r:()=>l});var r=i(28245),n=i(29191),o=i(37580),s=i(14209),a=i(63499);function l(e,t){const i=e.vertex;(0,n.Nz)(i),null==i.uniforms.get("markerScale")&&i.constants.add("markerScale","float",1),i.constants.add("markerSizePerLineWidth","float",r.PV).code.add(s.H`float getLineWidth() {
